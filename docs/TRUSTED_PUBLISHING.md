...
| Setting | Value |
|---|---|
| PyPI project | `confidence-escalation` |
| GitHub owner | `ashutoshrana` |
| Repository | `confidence-escalation` |
...
python -m pypi_attestations verify pypi \
  --repository https://github.com/ashutoshrana/confidence-escalation \
  "$ARTIFACT_URL"
```
